                                    ...
                                    {"LayoutMethod", "HList",  "Id", "idContainer"},
                                    {
                                        ...
                                        PlaceObj(
                                            ...
                                            {"Dock", "right", "LayoutMethod", "HList", "Margins", box(20, 10, 0, 0)},
                                            {
                                                ...
                                                PlaceObj("XTemplateWindow", {"__class", "XTextButton", "Id", "idRemove", "HAlign", "left", "VAlign", "center", "MouseCursor", "UI/Cursors/Rollover.tga", "FXMouseIn", "RocketRemoveCargoHover", "FXPress", "RocketRemoveCargoClick", "RepeatStart", 300, "RepeatInterval", 300, "OnPress", function() end, "Image", "UI/Infopanel/arrow_remove.tga", "ColumnsUse", "abcc"}),
                                                PlaceObj("XTemplateWindow", {"__class", "XText", "Text", Untranslated("0"), "Id", "idAmount", "Padding", box(2, 2, 5, 2), "HAlign", "right", "VAlign", "center", "MinWidth", 30, "MaxWidth", 50, "TextFont", "PGResource", "TextColor", RGBA(255, 248, 233, 255), "RolloverTextColor", RGBA(255, 255, 255, 255), "WordWrap", false, "TextHAlign", "right", "TextVAlign", "center"}),
                                                PlaceObj("XTemplateWindow", {"__class", "XTextButton", "Id", "idAdd", "HAlign", "right", "VAlign", "center", "MouseCursor", "UI/Cursors/Rollover.tga", "FXMouseIn", "RocketRemoveCargoHover", "FXPress", "RocketRemoveCargoClick", "RepeatStart", 300, "RepeatInterval", 300, "OnPress", function() end, "Image", "UI/Infopanel/arrow_add.tga", "ColumnsUse", "abcc"})
                                            }
                                        )
                                    }
                                )
